  ...
  return (
    <div className="w-full flex flex-col items-start justify-start">
      ...
      <div className="w-full flex flex-col items-start justify-start pt-16 pb-32 md:pt-[110px] px-10 md:px-[120px]">
        ...
        <p className='max-w-[90%] md:max-w-[720px] font-gatwickreg text-[16px] md:text-[24px] leading-7 md:leading-[38px]'>Our common mision is to use new technologies to build something new, to create something that didn't exist in the world before.</p>
        <p className='max-w-[85%] md:max-w-[748px] mt-12 mb-14 md:mb-11'>We didn't want to be <span className="italic">just another NFT-project</span>: the world isn't getting any better with yet another PFP, upon which some functionality is brute-forced after the facts. Sadly, there's too much of that going on.<br /><br />When we were discussing the NFT-sprawl in the summer of 2021, the question "If <span className='italic'>we</span> would ever create an NFT together, what would that look like?" did set in motion something of an elaborate brainstorm over the course of weeks, and a very pleasurable one at that. Admits a lot of laughs and a ton of fun, we did actually come up with a concept that we believe adds value to the world and the space, and has the ability to create something new and exciting. The structure of Skygazers can gather a solid community and channel a flow of creative energy, which can materialise in a unique scifi universe and experience, owned by its contributors.</p>



        <div className='w-full flex flex-col md:flex-row items-start justify-start mb-[60px] md:mb-[60px]'>
